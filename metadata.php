...
$aModule = array(
    ...
    'events'       => array(
        'onActivate' => \Wmdk\FactFinderQueue\Setup\ModuleEvents::class . '::onActivate',
    ),

    'extend' => array(
        \OxidEsales\Eshop\Application\Controller\Admin\ArticleExtend::class => \Wmdk\FactFinderQueue\Extension\Controller\Admin\ArticleExtend::class,
        \OxidEsales\Eshop\Application\Controller\Admin\ArticleFiles::class => \Wmdk\FactFinderQueue\Extension\Controller\Admin\ArticleFiles::class,
        \OxidEsales\Eshop\Application\Controller\Admin\ArticleMain::class => \Wmdk\FactFinderQueue\Extension\Controller\Admin\ArticleMain::class,
        \OxidEsales\Eshop\Application\Controller\Admin\ArticlePictures::class => \Wmdk\FactFinderQueue\Extension\Controller\Admin\ArticlePictures::class,
...
//            'template' => 'dx_savevariant_atonce.tpl',
    ...
    'settings' => array(
		...
		array('group' => 'sWmdkFFExportSettings', 'name' => 'sWmdkFFExportTmpDelimiter', 'type' => 'select', 'value' => 'xml', 'constraints' => 'csv|xml'),
		...
		array('group' => 'sWmdkFFDebugSettings', 'name' => 'sWmdkFFDebugLogFileQueue', 'type' => 'str', 'value' => 'log/KUSSIN_FACTFINDER_QUEUE.log'),
		array('group' => 'sWmdkFFDebugSettings', 'name' => 'sWmdkFFDebugLogFileExport', 'type' => 'str', 'value' => 'log/KUSSIN_FACTFINDER_EXPORT.log'),
		array('group' => 'sWmdkFFDebugSettings', 'name' => 'sWmdkFFDebugLogFileStock', 'type' => 'str', 'value' => 'log/KUSSIN_FACTFINDER_STOCK.log'),
		array('group' => 'sWmdkFFDebugSettings', 'name' => 'sWmdkFFDebugLogFileClonedAttributes', 'type' => 'str', 'value' => 'log/KUSSIN_FACTFINDER_CLONED_ATTRIBUTES.log'),
		array('group' => 'sWmdkFFDebugSettings', 'name' => 'sWmdkFFDebugLogFileCleanup', 'type' => 'str', 'value' => 'log/KUSSIN_FACTFINDER_CLEANUP.log'),
    ),
