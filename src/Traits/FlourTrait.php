...
trait FlourTrait
{
    ...
    {
        $flourId = $this->_getArticleFieldValue($this->_oProduct, 'wmdkflourid');

        return ($flourId != '') ? $flourId : NULL;
    }

    private function _getFlourActive()
    {
        return $this->_getArticleFieldValue($this->_oProduct, 'wmdkflouractive');
    }
    ...
    private function _getFlourPrice()
    {
        ...
        return (double) $this->_getArticleFieldValue($this->_oProduct, 'wmdkflourwarehouseprice');
    }
    ...
    {
        $sShortUrl = trim((string) $this->_getArticleFieldValue($this->_oProduct, 'wmdkflourshorturl'));
    ...
    private function _getFlourExportSelection()
    {
        ...
        $bFlourId = (bool) Registry::getRequest()->getRequestParameter('flour_id');
