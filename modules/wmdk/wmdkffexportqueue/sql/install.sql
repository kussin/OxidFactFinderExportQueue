...
ALTER TABLE `oxarticles`
	ADD COLUMN `WMDKVARSELECTMAPPING` VARCHAR(30) NOT NULL DEFAULT '' COMMENT 'WMDK Variants Mapping value' AFTER `OXVARSELECT`,
	ADD COLUMN `WMDKVARSELECTMAPPING_1` VARCHAR(30) NOT NULL DEFAULT '' COMMENT 'WMDK Variants Mapping value #1' AFTER `OXVARSELECT_1`,
	ADD COLUMN `WMDKVARSELECTMAPPING_2` VARCHAR(30) NOT NULL DEFAULT '' COMMENT 'WMDK Variants Mapping value #2' AFTER `OXVARSELECT_2`,
	ADD COLUMN `WMDKVARSELECTMAPPING_3` VARCHAR(30) NOT NULL DEFAULT '' COMMENT 'WMDK Variants Mapping value #3' AFTER `OXVARSELECT_3`;
