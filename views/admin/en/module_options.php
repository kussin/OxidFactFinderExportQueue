...
$aLang = array(
    ...
    'SHOP_MODULE_GROUP_sWmdkFFProductNameBuilderSettings' => 'Product Name Builder settings',
    ...
    'SHOP_MODULE_bWmdkFFExportPrettifyXml'              => 'Output formatted XML',
    'SHOP_MODULE_sWmdkFFExportTmpDelimiter' 	        => 'Tmp. delimiter',
    'SHOP_MODULE_sWmdkFFExportTmpDelimiter_csv'        => 'CSV: |',
    'SHOP_MODULE_sWmdkFFExportTmpDelimiter_xml'        => 'XML: #%#%#',
    ...
    'SHOP_MODULE_sWmdkFFProductNameBuilderPattern'      => 'Product name pattern',
    ...
    'SHOP_MODULE_sWmdkFFDebugLogFileCleanup'            => 'Log-File for queue cleanup',
);
